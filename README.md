...
보안 담당자로 일하면서 매일 아침 하는 일이 있습니다. 어제 공개된 CVE 중에 우리가 손대야 할 게 있는지
확인하는 일입니다.
...
공개된 취약점은 하루만 지나도 N-day가 되고, PoC가 돌기 시작하면 그다음은 시간 문제입니다.
...
CVSS 7점대가 하루 수백 건이라 점수만으로는 걸러지지 않습니다. 무엇을 먼저 볼지는 **실제 악용 신호**로 가릅니다.
