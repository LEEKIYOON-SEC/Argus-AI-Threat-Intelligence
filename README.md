...
오른 건은 곧 **패치가 나와 있는데도 실제로 악용됐다**는 뜻입니다.

| 2023년 사례 | CVE | KEV 등재 | CISA 조치 기한 | 랜섬웨어 악용 |
| :--- | :--- | :--- | :--- | :--- |
| 원격접속 게이트웨이 · Citrix NetScaler ADC·Gateway | `CVE-2023-4966` | 2023-10-18 | 2023-11-08 | 확인 |
| 파일 전송 · Progress MOVEit Transfer | `CVE-2023-34362` | 2023-06-02 | 2023-06-23 | 확인 |
| 메시지 미들웨어 · Apache ActiveMQ | `CVE-2023-46604` | 2023-11-02 | 2023-11-23 | 확인 |

<sub>조치 기한은 CISA가 미 연방기관에 지정한 것(BOD 22-01)으로 국내 기업에 법적 의무는 없습니다.
악용이 확인된 뒤 주어지는 시간이 3주 남짓이라는 기준으로 읽으면 됩니다. 출처: CISA KEV 카탈로그(2026-07-29).</sub>
